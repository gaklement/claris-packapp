const data = {
  packages: [
    { id: 'adHoc', name: 'adHoc', includePackageIds: [] },
    { id: 'test', name: 'test', includePackageIds: [] },
    { id: 'basics', name: 'Basics', includePackageIds: ['cosmetic'] },
    { id: 'beach', name: 'Strandurlaub', includePackageIds: [] },
    { id: 'byBus', name: 'Busreise', includePackageIds: [] },
    { id: 'byPlane', name: 'Flugzeugreise', includePackageIds: [] },
    { id: 'byTrain', name: 'Zugreise', includePackageIds: [] },
    { id: 'cosmetics', name: 'Kosmetik', includePackageIds: [] },
    { id: 'hiking', name: 'Wandern', includePackageIds: [] },
    { id: 'wedding', name: 'Hochzeit', includePackageIds: [] },
    { id: 'quietTime', name: 'Ruhe', includePackageIds: [] },
  ],
  items: [
